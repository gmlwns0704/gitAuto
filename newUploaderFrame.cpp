...
void newUploaderFrame::OnBnClickedOk()
{
	...
	GitUploader* newObj =  new GitUploader(projDir, projName, branch, gitURL);
...
BOOL newUploaderFrame::OnInitDialog()
{
	...
	GetDlgItem(IDC_EDIT_BRANCH)->SetWindowTextW(_T("GitProjectManagerBackup"));
